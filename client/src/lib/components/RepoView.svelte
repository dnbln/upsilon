...
<div class="repo-view-main">
	...
	<div class="repo-navigation">
		<div class="repo-navigation-elements">
			...
			>
			<button class="repo-navigation-element"
				><i class="fa fa-check-circle-o repo-navigation-icon" />Issues
			</button>
			<button class="repo-navigation-element"
				><i class="fa fa-random repo-navigation-icon" />Merge Requests
			</button>
			<button class="repo-navigation-element"
				><i class="fa fa-book repo-navigation-icon" />Wiki</button
			>
			<button class="repo-navigation-element"
				><i class="fa fa-comments repo-navigation-icon" />Discussion
			</button>
			<button class="repo-navigation-element"
