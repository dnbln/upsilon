...
<div class="repo-issues-controls">
    <div class="repo-issues-controls-group-left">
        <div class="repo-issues-controls-search">
            <input id="controls-search" type="text">
        </div>
    </div>
    <div class="repo-issues-controls-group-right">
        <div bind:this={cloneButton} class="repo-issues-controls-add">
            <button on:click={() => (showAddDropdown = !showAddDropdown)} id="button-add">
                New Issue <i class="fa fa-plus" style="margin-left: 5px; font-size: 0.7rem"></i>
            </button>
            {#if showAddDropdown}
